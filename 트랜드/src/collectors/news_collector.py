...
EXCLUDE_KEYWORDS = [
    ...
    "자립준비청년", "사회공헌",
    # 반려동물 — "장건강"·"면역력" 같은 범용 효능어가 펫푸드·펫영양제 기사에도
    # 흔해 그대로 걸러지던 문제 (2026-09-04, 고양이 간식/강아지 유산균 기사 다수 확인)
    "반려동물", "반려견", "반려묘", "펫푸드", "고양이", "강아지",
    # 의료 시술 — 성장호르몬 주사 기사가 "영양제는 효과 근거 부족"이라는
    # 비교 문구로 건기식 키워드를 달고 나와 상시 유입되던 문제 (2026-09-04)
    "성장호르몬",
    # 특정 인물 개인사 가십 — 여에스더·홍혜걸은 실제 건기식 업체 대표/유튜버라
    # 재산·결혼·부부싸움 같은 연예 가십 기사에도 "영양제 사업" 매출 언급이
    # 반복적으로 섞여 들어옴 (2026-09-04, 하루 8건 중 5건이 이 케이스였음)
    "여에스더", "홍혜걸",
    # 인물동정/잡화 로드업 컬럼 태그 — 본문 어딘가에 "건강기능식품" 단어가
    # 한 번 스칠 뿐 실제 주제는 임원 인사·타업종 잡보임 (2026-09-04)
    "[Who Is ?]", "[제약+]", "[잘먹잘살+]", "[시선집중]", "[뉴공 아카이브]", "김어준",
]
